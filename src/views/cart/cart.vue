<template>
  <div>
    <div v-if="error" class="max-w-md mx-auto bg-red-400 text-white p-2 my-2">
      Something went wrong
    </div>
    <div
      v-if="completed"
      class="max-w-md mx-auto bg-green-400 text-white p-2 my-2"
    >
      Thank you for your order
    </div>
    <div v-if="!completed && !error" class="pt-16 pb-8">
      ...
      <div>
        ...
        >
          ...
          <div class="w-1/4 text-right">
            Total:
            {{ rowFormattedTotalPrice(cartItem.quantity, cartItem.price) }}$
          </div>
        </div>
      </div>
